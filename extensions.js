...
export const VideoExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    function getYouTubeVideoID(url) {
      ...
      const fullRegex = /v=([a-zA-Z0-9_-]{11})/
    ...
    if (isYouTubeURL(videoURL)) {
      ...
      if (videoID) {
        ...
        iframe.width = '300' // Adjusted width
        iframe.height = '169' // Adjusted height (16:9 aspect ratio)
      ...
      videoElement.width = 240 // Adjust as needed
